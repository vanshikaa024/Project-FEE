      ...
      <section className="ss-kpi-grid">
        ...
        <div className="ss-kpi-card">
          ...
          <div className="ss-kpi-note">
            {safeOrders.length} completed orders
          </div>
        </div>
        ...
        <div className="ss-kpi-card">
          ...
          <div className="ss-kpi-note">
            {outOfStockProducts} products out
            of stock
          </div>
        </div>
      ...
      <section className="ss-main-grid">
        ...
        <div className="ss-card ss-inventory-card">
          ...
          <div className="ss-card-header">
            ...
            <div className="ss-header-control">
              Month <span>⌄</span>
            </div>
          </div>
          ...
          <div className="ss-inventory-body">
            ...
            <div className="ss-inventory-summary">
              ...
              <div className="ss-inventory-total">
                {totalProducts.toLocaleString(
                  "en-IN"
                )}
              </div>

              <div className="ss-inventory-total-label">
                Total Products
              </div>
    ...
    return (
      ...
      >
        ...
        <div className="ss-stock-track">
          ...
          {/* PERCENTAGE ABOVE THE COLORED BAR */}
          {item.value > 0 && (
            <span
        ...
        <div className="ss-card ss-attention-card">
          ...
          <div className="ss-attention-title">
            Needs Action
          </div>
            ...
            <div className="ss-attention-products">
              ...
              {attentionProducts
                ...
                .map((product) => {
                  ...
                  return (
                    <div
                      className="ss-attention-product"
                      key={product.id}
                    >
